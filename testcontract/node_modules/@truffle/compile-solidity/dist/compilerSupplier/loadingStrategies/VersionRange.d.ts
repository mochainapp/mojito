...
export declare class VersionRange {
    ...
    getCachedSolcByFileName(fileName: string): Promise<any>;
    getCachedSolcByVersionRange(version: string): Promise<any>;
    getCachedSolcFileName(commit: string): Promise<any>;
    getMostRecentVersionOfCompiler(versions: string[]): string;
    getSatisfyingVersionFromCache(versionRange: string): Promise<any>;
    ...
    versionIsCached(version: string): Promise<any>;
}
